...
<el-card class="box-card">
    ...
    <el-row class="seach">
        <el-col :sapn="7">
            <el-input placeholder="请输入内容" class="input-with-select" v-model="query" style="width: 40%">
    ...
    <el-table :data="users" border style="width: 100%">
        ...
        <el-table-column label="用户状态">
            ...
            <template slot-scope="scope">
                <!-- 开关 -->
                <el-switch v-model="scope.row.mg_state" active-color="#13ce66" inactive-color="#ff4949" @change="handeleStateChange(scope.row.id,scope.row.mg_state)"></el-switch>
            </template>
        </el-table-column>
    ...
    <el-dialog title="分配角色" :visible.sync="dialogFormVisibleRole" width="40%" 
      @close="formdata = {}">  <!-- 窗口关闭必须清除数据，否则会造成数据粘连 -->
