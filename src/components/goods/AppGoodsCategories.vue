...
<el-card class="box-card">
    ...
    <el-table :data="categories" border height="450">
        ...
        <!-- 树状列表 -->
        <el-tree-grid prop="cat_name" label="分类名称" treeKey="cat_id" parentKey="cat_pid" levelKey="cat_level" childKey="children" folderIcon="" :indentSize="30"></el-tree-grid>
    ...
    <el-dialog title="添加商品分类" :visible.sync="dialogFormVisibleAdd" width="40%" @close="handleEditClose()">
        <el-form :model="formdata">
            ...
            <el-form-item label="分类级别" label-width="100px">
                <el-cascader v-model="selectOptions" :options="caseCate" clearable :props="defaultProps" :show-all-levles="false">
                </el-cascader>
                如果不选，即根级
            </el-form-item>
        </el-form>
