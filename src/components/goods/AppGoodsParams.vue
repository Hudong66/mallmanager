...
<el-card class="box-card">
    ...
    <el-row class="24">
        <el-col :span="24">
            商品分类:
            <el-cascader v-model="selectOptions" :options="categorys" clearable :props="defaultProps" :show-all-levels="false" @change="handleChangeCategory">
...
export default {
    ...
    methods: {
        //删除动态参数
        handleCateDelete(id){
            this.$confirm('此操作将永久删除参数,是否继续?','警告',{
    ...
    async handleChangeCategory() {
        ...
        console.log(this.categoryDyParams)
        //处理动态属性 string->array
